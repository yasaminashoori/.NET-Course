    ...
    class Program
    {
        ...
        private static IQueryable<Student> GetStudentsList()
        {
            return new[] {
                ...
                new Student() {StudentId = 2, StudentName = "Jasmine Curly", Score = 86, StudentCity = "Berlin"},
                ...
                new Student() {StudentId = 7, StudentName = "Leo Aniston", Score = 83, StudentCity = "Florida"},
            }.AsQueryable();
        }
    }
}
